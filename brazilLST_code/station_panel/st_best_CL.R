# Extract variables for station panel
...
stpts <- stpts[, c("pixelid", "modislon", "modislat")]
...
stpts$x <- stpts$modislon
stpts$y <- stpts$modislat
...
bestpanel <- merge(bestminpanel,bestmaxpanel, by  = c("pixelid","yeardoy"), all=TRUE)
setwd(out_path)
save.dta13(bestpanel, paste("panel_bt_st.dta", sep=""))
