...
for (yr in yrend) {
  ...
  filename <- file(paste('st_lst_dpanel_',yr,'_CL.R', sep=''), open='w')
  ...
  write('ransample <- read.dta13(paste("lst_station_points.dta",sep=""))', filename, append=TRUE) 
  write('', filename, append=TRUE)
  ...
  write('gs_id <- ransample[, c("modislat", "modislon", "pixelid")]', filename, append=TRUE)
  ...
  write('coordinates(ran_points)=~modislon+modislat', filename, append=TRUE)
  ...
  write('gs_id <- melt(gs_id, id=c("pixelid", "modislon", "modislat"))', filename, append=TRUE)
  ...
  write('#reshape wide to long ', filename, append=TRUE)
  write('gs_id_qc <- melt(gs_id_qc, id=c("pixelid"))', filename, append=TRUE)
  ...
  write('gs_id <- merge(gs_id, gs_id_qc, by=c("pixelid", "yeardoy"))', filename, append=TRUE)
  write('#colnames(gs_id)', filename, append=TRUE)
  write('gs_id <- gs_id[, c("pixelid","yeardoy","lst","qc","qcbin1", "qcbin2", "qcbin3")]', filename, append=TRUE)
  write('setwd(out_path)', filename, append=TRUE)
  write('save.dta13(gs_id, paste("lst_st_",igsyear,".dta",sep=""))', filename, append=TRUE)
  write('}', filename, append=TRUE)
  close(filename) 
