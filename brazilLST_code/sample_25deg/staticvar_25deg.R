...
pts <- read.dta13("pfb1_25deg_sample_with_ag.dta")
...
#elevation <- getData('alt', country='BRA')
...
setwd(out_path)
save.dta13(ransample,"pfb1_25deg_ag_withstaticvar.dta")
